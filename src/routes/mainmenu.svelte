<script script type="ts">
  ...
  const gradientColor: string = `linear-gradient(${GameColors.grayscales.green[3]}, ${GameColors.grayscales.green[0]})`;
...
<div bind:this={menuContainer} style="background-image:{gradientColor};">
  <article>
